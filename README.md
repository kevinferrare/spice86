...
```
java -jar spice86-1.0.jar file.exe
```
...
```
java -jar spice86-1.0.jar file.exe --gdbPort=10000
```
...
```
java -cp 'overrides.jar:spice86-1.0.jar' spice86.main.Main file.exe --overrideSupplierClassName=my.program.MyProgramOverrideSupplier
```
